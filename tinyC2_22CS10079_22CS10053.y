...
%token PERIOD ARROW INCREMENT DECREMENT   SLASH PERCENT //AMPERSAND ASTERISK PLUS MINUS TILDE EXCLAMATION
...
postfix_expression  : primary_expression {printf("postfix_expression: primary_expression\n");}
                    ...
                    | postfix_expression '(' argument_expression_list_opt ')' {printf("postfix_expression: postfix_expression ( argument_expression_list )\n");}
                    ...
                    | '(' type_name ')' '{'initializer_list COMMA '}' {printf("postfix_expression: ( type_name ) { initializer_list , }\n");}
                    ;
...
enum_specifier  : ENUM identifier_opt '{' enumerator_list '}' {printf("enum_specifier: enum identifier_opt { enumerator_list }\n");}
                | ENUM identifier_opt '{' enumerator_list COMMA '}' {printf("enum_specifier: enum identifier_opt { enumerator_list , }\n");}
...
initializer : assignment_expression {printf("initializer: assignment_expression\n");}
            ...
            | '{' initializer_list COMMA '}' {printf("initializer: { initializer_list , }\n");}
            ;
...
iteration_statement : WHILE '(' expression ')' statement {printf("iteration_statement: while ( expression ) statement\n");}
                    | DO statement WHILE '(' expression ')' SEMICOLON {printf("iteration_statement: do statement while ( expression ) ;\n");}
                    | FOR '(' expression_opt SEMICOLON expression_opt SEMICOLON expression_opt ')' statement {printf("iteration_statement: for ( expression_opt ; expression_opt ; expression_opt ) statement\n");}
                    | FOR '(' declaration expression_opt SEMICOLON expression_opt ')' statement {printf("iteration_statement: for ( declaration expression_opt ; expression_opt ) statement\n");}
                    ;
